...
# credit_card_fraud_detection documentation build
...
from credit_card_fraud_detection import __version__ as release
...
texinfo_documents = [
    (
        ...
        author,
        "credit_card_fraud_detection",
        "Project credit_card_fraud_detection codebase.",
        "Data-Science",
    )
]
